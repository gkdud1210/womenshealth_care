...
export const ALL_QUESTIONS: Question[] = [
  ...
  {
    id: 'diet_craving',
    cardIds: ['weight_metabolic'],
    emoji: '⚖️', category: '체중 & 대사 케어',
  ...
  // ── 💪 남성 웰니스 & 벌크업 ───────────────────────────────────
  {
    id: 'male_testosterone',
    cardIds: ['male_wellness'],
    emoji: '💪', category: '남성 웰니스 & 벌크업',
    text: '최근 근력이나 활력이 예전보다 떨어졌다고 느끼시나요?',
    type: 'radio',
    options: ['자주 그래요', '가끔 그래요', '별로 없어요'],
  },
  {
  ...
  {
    id: 'posture_neck',
    cardIds: ['posture_correction'],
    emoji: '🧍', category: '체형 & 자세 교정',
    text: '거북목·일자목 증상이나 목·어깨 결림이 자주 있으신가요?',
    type: 'radio',
    options: ['자주 그래요', '가끔 그래요', '없어요'],
  },
  {
    ...
    cardIds: ['posture_correction'],
    emoji: '🧍', category: '체형 & 자세 교정',
    text: '오래 앉아있거나 짝다리를 짚는 습관으로 골반이 틀어진 느낌이 드시나요?',
    type: 'radio',
    options: ['네, 느껴요', '조금 그런 것 같아요', '아니요'],
  },
  ...
  // ── 🌱 장 건강 & 디톡스 ──────────────────────────────────────
  {
    id: 'gut_bloating',
    cardIds: ['gut_detox'],
    emoji: '🌱', category: '장 건강 & 디톡스',
    text: '식사 후 더부룩함이나 가스가 자주 차는 편인가요?',
    type: 'radio',
    options: ['자주 그래요', '가끔 그래요', '별로 없어요'],
  },
  {
    ...
    cardIds: ['gut_detox'],
    emoji: '🌱', category: '장 건강 & 디톡스',
    text: '배변 활동이 불규칙하거나 변비 · 설사를 반복하는 편인가요?',
    type: 'radio',
    options: ['자주 그래요', '가끔 그래요', '규칙적이에요'],
  },

  // ── 🌬️ 멘탈 & 뇌 건강 ─────────────────────────────────────────
  {
    id: 'stress_sleep',
    cardIds: ['mental_brain'],
    emoji: '🌬️', category: '멘탈 & 뇌 건강',
  ...
  // ── 🩸 호르몬 & 여성 케어 ────────────────────────────────────
  {
    ...
    cardIds: ['hormone_female'],
    emoji: '🩸', category: '호르몬 & 여성 케어',
  ...
  {
    id: 'fibroid_family',
    cardIds: ['disease_postcare'],
    emoji: '🛡️', category: '질환 관리 & 포스트 케어',
  ...
  {
    id: 'osteo_joint',
    cardIds: ['musculoskeletal_lymph'],
    emoji: '🦴', category: '근골격 & 림프 순환',
  ...
  {
    id: 'thyroid_checkup',
    cardIds: ['organ_monitoring'],
    emoji: '📈', category: '기관 징후 & 정기 모니터링',
