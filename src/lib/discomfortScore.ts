...
const RADIO_SCORES: Record<string, Record<string, number>> = {
  ...
  male_testosterone:    { '자주 그래요': 10,        '가끔 그래요': 5,           '별로 없어요': 0 },
  male_prostate:        { '자주 그래요': 10,        '가끔 그래요': 5,           '없어요': 0 },
  posture_neck:         { '자주 그래요': 10,        '가끔 그래요': 5,           '없어요': 0 },
  posture_pelvis:       { '네, 느껴요': 10,         '조금 그런 것 같아요': 5,   '아니요': 0 },
  gut_bloating:         { '자주 그래요': 10,        '가끔 그래요': 5,           '별로 없어요': 0 },
  gut_bowel:            { '자주 그래요': 10,        '가끔 그래요': 5,           '규칙적이에요': 0 },
}
